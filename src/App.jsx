...
import AddCustomer from "./pages/PrivatePage/AddCustomer/AddCustomer";  // Admin ka add customer
...
// import Quotation from "./pages/PrivatePage/Quotation/Quotation";
    ...
    <ThemeProvider>
      <BrowserRouter>
        <Routes>
          ...
          {/* ✅ Add Customer - دونوں URLs ایک ہی page پر جائیں گے */}
          <Route
